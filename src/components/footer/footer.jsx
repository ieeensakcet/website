                          ...
                          <div className="col-sm-6 col-md-3">
                              <div className="widget widget-text">
                                  ...
                                  <div className="contact-detail">
                                      <ul>
                                          <li><i className="icofont icofont-location-pin gradient-color"></i>16-4-1, New Malakpet, Near Railway Station, Hyderabad, Telangana, India, 500024</li>
                                          <li><i className="icofont icofont-ui-call gradient-color"></i>+91 8500752481</li>
                                          <li><i className="icofont icofont-envelope gradient-color"></i>ieeensakcet@gmail.com</li>
                                      </ul>
                                  </div>
                              </div>
                          </div>
                          ...
                          <div className="col-sm-6 col-md-3">
                              <div className="widget widget-links">
                                  ...
                                  <ul>
                                      ...
                                      <li><a href="#">Signal Processing Society</a></li>
                                  </ul>
                              </div>
                          </div>
                          <div className="col-sm-6 col-md-3">
                              <div className="widget widget-text">
                                  ...
                                  <p><a href="#" className="icofont icofont-social-facebook">  Facebook</a></p>
                                  <p><a href="#" className="icofont icofont-social-twitter">  Twitter</a></p>
                                  <p><a href="#" className="icofont icofont-social-instagram">  Instagram</a></p>
                                  <p><a href="#" className="icofont icofont-social-linkedin">  LinkedIn</a></p>
                              </div>
                          </div>
                      </div>
                  </div>
